...
void main() {
  ...
  // Teal color palette: shifting hues around teal/cyan/emerald
  // Using offsets that keep us in the teal-cyan range
  vec3 pha = 0.5 + 0.5 * cos(u_time * 0.3 + uv.xyx + vec3(2.5, 4.0, 3.0));

  // Bias the palette toward teal: suppress red, boost green and blue
  pha.r *= 0.15;
  pha.g *= 0.85;
  pha.b *= 0.75;
